...
interface IBank {
	...
	// in interface 100% contract base , that means 100% implementation of the child class
	// class
	...
	public static void senSMSNotification() {

		// 250(50 for connection + 2000 biz logic )
		createConnection();
	}

...
//		System.out.println("Welcome to our e-commerce website");
		...
		logger.info("Welcome to our e-commerce website");
//		System.out.println("List of available customers are as follows: ");
		
		logger.info("List of available customers are as follows: ");
...
//		System.out.println("Please enter the customer Id before proceeding");
		...
		logger.info("Please enter the customer Id before proceeding");
...
//				System.out.println("Wrong input!! please try again");
				...
				logger.warn("Wrong input!! please try again");
				sc.nextLine(); 
...
//		System.out.println("Press 11 to exit");
		...
		logger.info("Press 1 to see available products");
		logger.info("Press 2 to search availble products");
		logger.info("Press 3 to sort products by price low-high");
		logger.info("Press 4 to sort products by price high-low");
		logger.info("Press 5 to add product to cart");
		logger.info("Press 6 to remove product from cart");
		logger.info("Press 7 to update quantity of product from cart");
		logger.info("Press 8 to check cart");
		logger.info("Press 9 to check-out");
		logger.info("Press 10 to show order history");
		logger.info("Press 11 to exit");
...
//			System.out.print("Please select an option : ");
			logger.debug("Please select an option : ");
			try {
...
//					System.out.println("Thanks for using the website!!");
					logger.info("Thanks for using the website!!");
					connection.close();
					System.exit(0);
					break;
				default:
//					System.out.println("Wrong option, please try again!");
					logger.warn("Wrong option, please try again!");
					break;
				}
